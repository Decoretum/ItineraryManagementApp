...
public final class AdminActivity_
    extends AdminActivity
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public static AdminActivity_.IntentBuilder_ intent(Context context) {
        return new AdminActivity_.IntentBuilder_(context);
    }

    public static AdminActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new AdminActivity_.IntentBuilder_(fragment);
    }

    public static AdminActivity_.IntentBuilder_ intent(androidx.fragment.app.Fragment supportFragment) {
        return new AdminActivity_.IntentBuilder_(supportFragment);
    }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<AdminActivity_.IntentBuilder_>
    {
        private android.app.Fragment fragment_;
        private androidx.fragment.app.Fragment fragmentSupport_;

        public IntentBuilder_(Context context) {
            super(context, AdminActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), AdminActivity_.class);
            fragment_ = fragment;
        }
