    ...
    implements BeanHolder, HasViews, OnViewChangedListener
{
    ...
    public static MainActivity_.IntentBuilder_ intent(androidx.fragment.app.Fragment supportFragment) {
    ...
    public void onViewChanged(HasViews hasViews) {
        View view_next = hasViews.internalFindViewById(R.id.next);

        if (view_next!= null) {
            view_next.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View view) {
                    MainActivity_.this.next();
                }
            }
            );
        }
